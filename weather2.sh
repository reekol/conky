...
getForecast(){
    ...
    for i in $(seq 1 10); do
        ...
        if [ $format = "short" ]; then
            echo '${goto 50}${voffset 5}${font Monospace:size=7}'$dropText'|'$day'|'$temps'${image '$imgCond' -s 20x20 -p 0,' $(( 435 + (i-1) * 18 ))' -f 86400} ${image '$imgDrop' -s 14x14 -p 25,'$(( 435 + (i-1) * 18 ))' -f 86400}'
        else
